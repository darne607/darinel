...
read -p "Seleccione un numero o letra: " readvalue
#CRIA KEY
[[ ! -e ${DIR}/${KEY} ]] && mkdir ${DIR}/${KEY}
#PASSA ARQS
[[ -z $readvalue ]] && readvalue="b"
read -p "Nombre de Usuario ( Nombre del Key ): " nombrevalue
...
echo -e "$BARRA"
echo -e "Key Ativada, y Guardando Instalacion!"
echo -e "$BARRA"
}
ofus () {
unset txtofus
